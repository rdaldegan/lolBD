...
export default async function handler(req, res) {
  ...
  var sql = `SELECT idCampeao, nomeCampeao, textoCampeao, regiao, pontos, nivel FROM campeao, maestria, jogador WHERE (nickname='${query.user}' AND idJogador=jogador_id AND idCampeao=campeao_id);`;
